    ...
    <div className={`text-center relative border-b-[8px] border-double border-blue-900 pb-8 mb-8 w-full ${isLandscape ? 'px-10' : 'px-4'} animate-in fade-in duration-1000`}>
      ...
      <div className="absolute top-0 left-0 w-24 h-24 flex items-center justify-center no-print">
        {settings.schoolLogo ? (
          ...
          <div className="w-16 h-16 bg-blue-900 text-white rounded-2xl flex items-center justify-center font-black text-2xl shadow-2xl">UBA</div>
        )}
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-center items-center gap-12 text-[12px] font-black text-gray-800 uppercase tracking-[0.3em] mt-6">
           <div className="flex flex-col items-center"><span className="text-[7px] text-blue-400 mb-1">TERM</span><span className="bg-blue-900 text-white px-4 py-1 rounded-lg">{settings.termInfo}</span></div>
           <div className="flex flex-col items-center"><span className="text-[7px] text-blue-400 mb-1">SERIES ID</span><span className="text-blue-600">{settings.activeMock}</span></div>
           <div className="flex flex-col items-center"><span className="text-[7px] text-blue-400 mb-1">YEAR</span><span className="italic">{settings.academicYear}</span></div>
        </div>
      </div>
    </div>
  );
