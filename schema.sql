...
-- 2. IDENTITY REGISTRY (The source of truth for Recall/Handshake)
CREATE TABLE IF NOT EXISTS public.uba_identities (
    email TEXT PRIMARY KEY,
    full_name TEXT NOT NULL,
    node_id TEXT NOT NULL, -- The specific ID (Hub ID or Index ID)
    hub_id TEXT NOT NULL,  -- The ID of the institution they belong to
...
-- ALLOW LOGIN PORTAL TO MATCH IDENTITIES (Anonymously)
